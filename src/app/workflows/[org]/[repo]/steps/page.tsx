...
import { DependencyListDataItem, getDependencyDetails } from "@/lib/api";
...
export default function WorkflowStepsPage() {
  ...
  const [dependencyData, setDependencyData] =
    useState<DependencyListDataItem | null>(null);
  ...
  const workflowSteps = [
    ...
    },
    {
      ...
      title: "Inquiry",
      description:
        "Make inquiries using information from contribution credentials",
      status: "in_progress",
    },
    {
      id: 3,
      ...
      description:
        "Generate acknowledgment documents for dependency relationships",
      status: "pending",
    },
    {
      id: 4,
    ...
    },
    {
      ...
      title: "Notarization",
      description:
        "Complete blockchain notarization of dependency contributions",
      status: "pending",
    },
  ];
              ...
              <React.Fragment key={step.id}>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="text-center mt-3">
                    ...
                    <p
                      className={`mt-1 text-xs max-w-[120px] ${
                        step.status === "pending"
                          ? "text-gray-400"
                          : "text-gray-500"
                      }`}
                  ...
                  <div className="mt-1 flex items-center">
                    <div className="flex-1 h-2 bg-gray-200 rounded-full">
                      <div
                        ...
                        style={{
                          width: `${dependencyData.contributionPercentage}%`,
                        }}
                      ></div>
                    </div>
