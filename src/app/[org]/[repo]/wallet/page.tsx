...
export default function WalletPage() {
  ...
  const workflowSteps = [
    ...
    {
      id: 3,
      title: "Allocate Funds Based on Contributions",
      status: "pending",
    },
        ...
        return (
          <>
            ...
            <p className="text-center text-gray-600 mb-10">
              Create a multisig wallet for distributing contribution rewards,
              making open source contributions more valuable.
            </p>

            <div className="mb-10">
              <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-lg">
                <h3 className="text-lg font-medium text-blue-800 mb-2">
                  Role of Multisig Wallet
                </h3>
                <ul className="list-disc list-inside text-blue-700 space-y-2">
                  <li>Manage project developer contribution records</li>
                  <li>
                    Provide transparent, secure reward mechanisms for
                    contributors
                  </li>
        ...
        return (
          <>
            ...
            <p className="text-center text-gray-600 mb-8">
              We want you to understand the purpose of creating a multisig
              wallet and the project workflow
            </p>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-700">
                    <strong>Important Note:</strong> You need to add the in-site
                    signature wallet address as one of the multisig members.
                    In-site wallet address:{" "}
                    <span className="font-mono">{signatureWalletAddress}</span>
                  </p>
                </div>
              </div>
            </div>
      ...
      case 3:
        return (
          <>
            ...
            <p className="text-center text-gray-600 mb-8">
              This multisig wallet address will only be used for this project
              workflow. Please enter your multisig wallet address created on
              other platforms.
            </p>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-blue-700">
                    <strong>Please Note:</strong> This wallet address will be
                    used to receive funds and distribute contribution rewards.
                    Please ensure that the in-site signature wallet address has
                    been added as one of the multisig members.
                  </p>
                </div>
              </div>
            </div>
