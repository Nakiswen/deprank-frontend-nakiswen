    ...
    const fetchDependencyInfo = async () => {
      try {
        ...
        if (!result.success || !result.data) {
          throw new Error(
            result.message || "Could not find this dependency information"
          );
        }
        ...
        if (
          dependencyData.contributors &&
          Array.isArray(dependencyData.contributors)
        ) {
          contributors = dependencyData.contributors.map(
        ...
        if (isLoggedIn && session?.user?.username) {
          const userIsContributor =
            ...
            contributorUsername.toLowerCase();
        ...
        setError(
          err instanceof Error
            ? err.message
            : "Error getting dependency information"
        );
      } finally {
        setIsLoading(false);
      }
  ...
  return (
    <main className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-12 pt-32">
      ...
      <div className="w-full max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              ...
              <div className="space-y-3">
                ...
                {dependencyInfo.contributors &&
                  dependencyInfo.contributors.length > 5 && (
                    <Link
            ...
            <div>
              ...
              <div className="mt-1 text-gray-900 text-sm">
                {dependencyInfo.contributionPercentage}% contributed by @
                {dependencyInfo.contributorName}
              </div>
            </div>
          </div>
          ...
          <div className="mt-6">
            {isContributor ? (
              ...
              <div className="text-gray-600">
                You are not a contributor to this dependency package. If you
        ...
        {dependencyInfo.codeSnippets &&
          dependencyInfo.codeSnippets.length > 0 && (
              ...
              {dependencyInfo.codeSnippets.map((snippet, index) => (
                ...
                >
                  <CodeBlock
                    ...
                    fileName={
                      snippet.fileName || `code-example-${index + 1}.tsx`
                    }
