      ...
      try {
        ...
        if (status === "unauthenticated") {
          ...
          if (retryCount < maxRetries) {
            ...
            setError(
              "Authorization failed, unable to get user information. Please try logging in again."
            );
            setIsLoading(false);
        ...
        if (status === "authenticated" && session) {
          ...
          console.log(
            "Login successful, preparing to redirect to:",
            redirectPath
          );
        ...
        setError(
          err instanceof Error
            ? err.message
            : "An error occurred during authorization processing. Please try again."
        );
        setIsLoading(false);
      }
    };
      ...
      <div className="bg-white/90 rounded-2xl shadow-xl border border-gray-100 px-8 py-6 max-w-md w-full">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Please wait, processing your GitHub authorization...
          </p>
